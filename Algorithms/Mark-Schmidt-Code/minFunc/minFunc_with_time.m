function [x, f, exitflag, output] = minFunc_with_time(funObj, x0, options, varargin)
% [x, f, exitflag, output] = minFunc_with_time_and_accuracy(funObj, x0, options,  varargin)
%
